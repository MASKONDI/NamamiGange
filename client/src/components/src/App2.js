...
class App extends Component {
  ...
  setLocation = async event => {
    ...
    this.setState({
      messageafterreinitiation: "newlocation has been initiated"
    });
  };
  ...
  checkteamaddress = async event => {
    ...
    // teamno pass karna h
    console.log("hi");
    const teamaddress = await contract.methods
      .checkteamaddress(parseInt(this.state.teamno, 10))
      .call();
    console.log("bye");
  ...
  makejudge = async event => {
    ...
    await contract.methods
      .makejudge("0xf9C790d9F6a7d5FdD333D08356Afe892818Be785")
      .send({
        from: accounts[0]
      });
  ...
  judgesdetail = async event => {
    ...
    for (var i = 0; ; i++) {
      ...
      console.log(judges);
      this.setState({
        judges: this.state.judges + (i + 1) + ". " + judges + "\n"
      });
    }
  };
  ...
  render() {
    return (
      <div className="namamigange">
        <h1 align="center">NAMAMI GANGE CONTRACT</h1>
        <h3 align="justify">
          Namami Gange Project Location {this.state.locationofproject} and is
          being managed by {this.state.manager} and has {this.state.balance}{" "}
          ether in it. If you want to donate money send the money at this
          address 0x90F1bAa353F6f6882cCF4D3A270FE16ea74F9156
        </h3>
        ...
        <form onSubmit={this.checkteamaddress}>
          <h4>&nbsp;&nbsp; check corresponding team address </h4>&nbsp;&nbsp;
          <input
        ...
        <form onSubmit={this.makejudge}>
          <h4>
            {" "}
            &nbsp;&nbsp;Only manager can call this function to make judges{" "}
          </h4>
          &nbsp;&nbsp;
          <input
        ...
        <form onSubmit={this.voteTheTeam}>
          <h4>
            &nbsp;&nbsp; This field is for judges so that they can vote. First
            field is for teamno and second one is for vote(true or false)
          </h4>
          &nbsp;&nbsp;
          <input
            value={this.state.teamno}
          ...
          <input
            ...
            onChange={event =>
              this.setState({ booleanforteamvote: event.target.value })
            }
          />
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <form onSubmit={this.finalfunction}>
          <h4>
            &nbsp;&nbsp; this msg is supposed to call when all the work is done,
            To pay the amount{" "}
          </h4>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <button>Enter</button>
        ...
        <form onSubmit={this.setlocation}>
          <h4>
            &nbsp;&nbsp; Only manager can call this function to reinitiate the
            contract for different location{" "}
          </h4>
          &nbsp;&nbsp;
          <input
